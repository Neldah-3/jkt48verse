  ...
  return (
    <div className="dark max-w-[420px] mx-auto mt-6 text-text">
      <div className="card w" style={{ background: "#151a22", borderColor: "#232b38", color: "#eef1f6" }}>
        <div className="flex items-center gap-3"><Logo size={34} /><div><div className="font-bold text-[15px]">Panel Admin / Moderator</div><div className="text-[11.5px]" style={{ color: "#95a0b1" }}>Halaman internal — jangan dibagikan</div></div></div>
        <StaffLoginForm />
